...
temp = []
temp.append(gmphd.GmphdComponent(1, [0, 0], [1, 0, 0, 1]))
temp.append(gmphd.GmphdComponent(10, [0, 0], [1, 0, 0, 1]))
temp.append(gmphd.GmphdComponent(13, [0, 25], [1, 0, 0, 1]))

I = list(enumerate(i.weight for i in temp))
# print I
# print gmphd.argmax(I)
print np.argmax([i.weight for i in temp])
print I[0]
# da decidere quale dei due presentare
